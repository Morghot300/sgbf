...
public class FiphVersionPdfService {
    ...
    private String construireXhtml(FIPH fiph, FIPHVersion version, List<Pointage> pointages, List<Validation> validations,
        ...
        return """
                ...
                fiph.getNumeroSemaine(), fiph.getAnnee(), fiph.getDateDebutPeriode().format(FORMAT_DATE),
                version.getDateFinPeriode() != null ? version.getDateFinPeriode().format(FORMAT_DATE) : "non encore definie",
                signatureEmetteur,
