...
public interface BonSortieMapper {
    ...
    @Mapping(target = "missionSelectionneeId", source = "mission.id")
    @Mapping(target = "missionSelectionneeCodeHN", source = "mission.codeHN.code")
    @Mapping(target = "missionSelectionneeChantierLibelle", source = "mission.chantier.libelle")
